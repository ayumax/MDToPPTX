...
namespace MDToPPTX.PPTX.DefaultParts
{
    internal class DefaultTheme
    {
        public static ThemePart CreateTheme(SlideMasterPart slideMasterPart1)
        {
            ...
            return themePart1;
            D.Theme theme1 = new D.Theme() { Name = "My Theme" };
        ...
        private static void GeneratePartContent(ThemePart part)
        {
            ...
            A.LatinFont latinFont1 = new A.LatinFont() { Typeface = "游ゴシック Light", Panose = "020F0302020204030204" };
            ...
            A.LatinFont latinFont2 = new A.LatinFont() { Typeface = "游ゴシック", Panose = "020F0502020204030204" };
